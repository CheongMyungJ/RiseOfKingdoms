...
Console.WriteLine("- 각 특성 별 상세특성 정보를 입력해주세요. 단, 일부 특성은 레포트에 이미 반영되어 있습니다.");
SelectInfo.SetSubCharacter(commander_at);
Console.WriteLine("- 착용한 악세서리를 두 개 선택해주세요. ex) 1,2");
