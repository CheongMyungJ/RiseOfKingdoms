    ...
    internal static class ViewBuff
    {
        public static void ViewAdditionalBuff(CommanderBase at, CommanderBase df)
        {
            ...
            Console.WriteLine("공격력 : {0}\n방어력 : {1}\n생명력 : {2}\n피해증가 : {3}\n피해감소 : {4}\n스킬피해증가 : {5}\n스킬피해감소 : {6}\n" +
                ...
                at.additionalNormalDamageDecrease, at.additionalCounterDamageIncrease, at.additionalCounterDamageDecrease);
            ...
            Console.WriteLine("공격력 : {0}\n방어력 : {1}\n생명력 : {2}\n피해증가 : {3}\n피해감소 : {4}\n스킬피해증가 : {5}\n스킬피해감소 : {6}\n" +
                ...
                df.additionalNormalDamageDecrease, df.additionalCounterDamageIncrease, df.additionalCounterDamageDecrease);
        }
